...
namespace fonts {
extern const unsigned int fontawesome5_solid_compressed_size;
extern const unsigned int fontawesome5_solid_compressed_data[136544/4];
} // namespace fonts
